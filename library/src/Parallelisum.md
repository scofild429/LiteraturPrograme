...
### old note
  ...
  ----------------------------------- -----------------
  docker images                       查看容器
  docker pull nginx [^1]              新增
  docker run -d -p 80:80 nginx [^2]   开始，id， 后台
...
-   the shared levels are readonly, and containers communicate with
    sockets or Restful API

### delete

-   delete docker

docker ps -a // get dockerid or dockername docker stop Did/Dname docker
rm Did/Dname

-   delete image docker images // get image id or image name docker rmi
    Iid/Iname perhaps some none name image should also be rm
...
and this can be rewrite as following, for in parallel, but can be
multiple for block
...
another form, parallel and sections can also be separated, and with
mulitple sections block but each sections are not paralleled, but
concatenated
...
after the block of private for, there are some wired to execute some out
of parallelisum
...
all iterations will be equally divied to each thread schedule(static,
size): size time iterations will be drived each time
...
C-h v : org-babel-C-compiler change gcc to mpicc mpirun
--use-hwthread-cpus mpirun --host si-u20:8

MPI~COMMWORLD~
--------------

``` {.c org-language="C" results="output" exports="both" tangle="./babel/MPI_COMM_WORLD.c"}
#include <stdio.h>
#include <stdlib.h>
#include <mpi.h>
int main(int argc, char* argv[])
...
Multi Thread {#multi-thread id="9a0bb2b3-cdb5-4ad4-9556-494718b41501"}
------------
...
rewrite [[init]{.underline}]{.underline} and run in class, which inherit
class threading.Thread, and start it with start()
...
Multi processing {#multi-processing id="493fb105-3ca1-4a4a-87b8-94afa870e5b1"}
----------------
...
5.  apply~async~ with callback, must use wait
...
``` {.python results="output" exports="both" tangle="./babel/mpi_python_example01.py"}
...
``` {.python results="output" exports="both" tangle="./babel/mpi_python_example02.py"}
from mpi4py import MPI
import numpy
comm = MPI.COMM_WORLD
rank = comm.Get_rank()
...
``` {.python results="output" exports="both" tangle="./babel/mpi_python_example03.py"}
from mpi4py import MPI
comm = MPI.COMM_WORLD
rank = comm.Get_rank()
if rank == 0:
...
``` {.python results="output" exports="both" tangle="./babel/mpi_python_example07.py"}
from mpi4py import MPI
import numpy as np
comm = MPI.COMM_WORLD
rank = comm.Get_rank()
...
``` {.python results="output" exports="both" tangle="./babel/mpi_python_example04.py"}
from mpi4py import MPI
comm = MPI.COMM_WORLD
size = comm.Get_size()
rank = comm.Get_rank()
...
``` {.python results="output" exports="both" tangle="./babel/mpi_python_example08.py"}
from mpi4py import MPI
import numpy as np
comm = MPI.COMM_WORLD
size = comm.Get_size()
...
``` {.python results="output" exports="both" tangle="./babel/mpi_python_example05.py"}
from mpi4py import MPI
comm = MPI.COMM_WORLD
size = comm.Get_size()
rank = comm.Get_rank()
...
``` {.python results="output" exports="both" tangle="./babel/mpi_python_example09.py"}
from mpi4py import MPI
import numpy as np
comm = MPI.COMM_WORLD
size = comm.Get_size()
...
``` {.python results="output" exports="both" tangle="./babel/mpi_python_example_client.py"}
from mpi4py import MPI
import numpy
import sys
...
``` {.python results="output" exports="both" tangle="./babel/mpi_python_example_server.py"}
from mpi4py import MPI
import numpy
...
``` {.go results="output" exports="both" tangle="./babel/go_mpi_cpuNum.go"}
package main
import (
    "fmt"
    "runtime"
...
``` {.go results="output" exports="both" tangle="./babel/go_mpi_ison.go"}
package main
...
``` {.go results="output" exports="both" tangle="./babel/go_mpi_WorldRank.go"}
package main
...
``` {.go results="output" exports="both" tangle="./babel/go_mpi_WorldSize.go"}
package main
...
``` {.go results="output" exports="both" tangle="./babel/go_mpi_NewCommunicator.go"}
package main
...
``` {.go results="output" exports="both" tangle="./babel/go_mpi_NewCommunicator_withranks.go"}
package main
...
``` {.go results="output" exports="both" tangle="./babel/go_mpi_SendInt32.go"}
package main
import (
        "fmt"
        mpi "github.com/sbromberger/gompi"
...
``` {.go results="output" exports="both" tangle="./babel/go_mpi_SendUInt32s.go"}
package main
...
``` {.go tangle="./babel/go_mpi_SendString.go"}
package main
...
``` {.go tangle="./babel/go_mpi_ReduceInt32s.go"}
package main
...
``` {.go tangle="./babel/go_mpi_AllreduceInt64s.go"}
package main
import (
        "fmt"
        mpi "github.com/sbromberger/gompi"
...
``` {.go tangle="./babel/go_mpi_BcastInt64s.go"}
package main
import (
        "fmt"
        mpi "github.com/sbromberger/gompi"
...
``` {.go tangle="./babel/go_mpi_distributed-client.go"}
package main
...
``` {.c org-language="C" tangle="./babel/gpu_get_variables.cu"}
#include <stdio.h>
#include <cuda.h>
#include <assert.h>
...
``` {.c org-language="C" tangle="./babel/gpu_vector_add_withoutpara.cu"}
#include <stdio.h>
#include <stdlib.h>
#include <math.h>
#include <assert.h>
...
``` {.c org-language="C" tangle="./babel/gpu_vector_add_dim1_grid1_block256.cu"}
#include <stdio.h>
#include <stdlib.h>
#include <math.h>
#include <assert.h>
...
``` {.c org-language="C" tangle="./babel/gpu_vector_add_dim1_grid1_block256_withtime.cu"}
#include <stdio.h>
#include <stdlib.h>
#include <math.h>
#include <assert.h>
...
``` {.c org-language="C" tangle="./babel/dim1_gridN_block1.cu"}
#include <stdio.h>
#include <cuda.h>
#include <cuda_runtime.h>
#include <curand_kernel.h>
...
``` {.c org-language="C" tangle="./babel/dim1_gridN_block1_N256.cu"}
#include <stdio.h>
#include <cuda.h>
#include <cuda_runtime.h>
#include <curand_kernel.h>
...
``` {.c org-language="C" tangle="./babel/gpu_vector_add_dim1_gridx_block256.cu"}
#include <stdio.h>
#include <stdlib.h>
#include <math.h>
#include <assert.h>
...
``` {.c org-language="C" tangle="./babel/gpu_vector_add_dim2_grid1_blockNxN.cu"}
#include <stdio.h>
#include <cuda.h>
#include <assert.h>
#include <cuda_runtime.h>
...
``` {.c org-language="C" tangle="./babel/gpu_vector_add_dim2_grid1_blockNxN_matrix.cu"}
#include <stdio.h>
#include <cuda.h>
#include <assert.h>
#include <cuda_runtime.h>
...
``` {.c org-language="C" tangle="./babel/gpu_vector_add_dim2_grid1_blockNxN_matrix_witharray.cu"}
#include <stdio.h>
#include <cuda.h>
#include <assert.h>
#include <cuda_runtime.h>
...
[^1]: 对于新到手的项目可以直接放到容器的nginx根目录（快速部署
    /usr/share/nginx/html），可以在映射的本机端口进入
