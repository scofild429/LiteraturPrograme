...
** Jetbrain Settings
|-------------------------+-------------------------------------+--------------------|
| Toggle sticky Selection | C-spc                               | 设定开始mark的位置 |
|-------------------------+-------------------------------------+--------------------|
| C-x, C-c                | close tab page                      | 关闭打开的文件     |
| shift   Alt   up        | move line up                        | 行上移             |
| shift   Alt   down      | move line down                      | 行下移             |
|-------------------------+-------------------------------------+--------------------|
| Ctrl  (alt/shift)  +    | Folding/expand (recursively/ all)   | 展开代码           |
| Ctrl  (alt/shift)  -    | Folding/Collapse (recursively/ all) | 折叠代码           |
| Ctrl  d                 | compare the difference              | 同打开文件比较代码 |
...
| Alt  shift ; | comment block       | 注释块               |
| Alt  w       | cope                | 复制                 |
| Alt  l       | reformat file       | 格式化文件格式(缩进) |
| Alt  y       | paste               | 粘贴                 |
| Ctrl  y      | paste  from history | 粘贴                 |
