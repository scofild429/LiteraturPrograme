...
* Concepts
** State & Action
- State: at a time point, for all parts, how the world looks like
- State space: at a time point, for all parts, how the world could look like
- action: at a time point, for each parts, what I do
...
- state transition probability: at a time point, if I did one operation, How the world can be changed.
